...
import `in`.francl.cam.domain.ports.outbound.authorization.OAuth2Credentials
...
import `in`.francl.cam.infrastructure.cache.Cache
...
class SecurityTokenServiceAdapter(
    ...
    private val cache: Cache<Set<String>, TokenExpirable>,
